...
void setup() {
  ...
  Serial.println("Send the character 'y' to go 10000");
  Serial.println("Send the character 't' to go -10000");
  Serial.println("Send the character 'u' to stop");
}
...
void loop() {
  ...
  if (Serial.available()) {
    ...
    if (c == 't') {
      Serial.println("1000");
      odrive.SetVelocity(0,-10000);
      odrive.SetVelocity(1,-10000);
